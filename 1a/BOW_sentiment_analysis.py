...
#scheduler = optim.lr_scheduler.MultiStepLR(optimizer,milestones=[7,14],gamma=gamma_in)
...
#print('Multistep LR scheduler with gamma: %.2f'% gamma_in)
#print('Multistep LR scheduler at steps: ', step_in)
...
torch.save(model,'BOW_mod_10.model')
data = [train_loss,train_accu,test_accu]
data = np.asarray(data)
np.save('data_mod_10.npy',data)